...
INSERT INTO EVENTOS(ID, DESCRICAO, DATA, HORA, QTD_PESSOAS, LOCAIS_ID) VALUES(1, 'Guerreiros Open Summer', '2016-11-12', '20:00', 250, 2);
...
CREATE SEQUENCE IF NOT EXISTS public.SEQ_CLASSIF_DESPESAS;
ALTER SEQUENCE SEQ_CLASSIF_DESPESAS RESTART WITH 5;
CREATE SEQUENCE IF NOT EXISTS public.SEQ_DESPESAS;
ALTER SEQUENCE SEQ_DESPESAS RESTART WITH 6;
CREATE SEQUENCE IF NOT EXISTS public.SEQ_RECURSOS;
ALTER SEQUENCE SEQ_RECURSOS RESTART WITH 5;
CREATE SEQUENCE IF NOT EXISTS public.SEQ_LOCAIS;
ALTER SEQUENCE SEQ_LOCAIS RESTART WITH 3;
CREATE SEQUENCE IF NOT EXISTS public.SEQ_EVENTOS;
ALTER SEQUENCE SEQ_EVENTOS RESTART WITH 1;
CREATE SEQUENCE IF NOT EXISTS public.SEQ_EVENTOS_DESPESAS;
ALTER SEQUENCE SEQ_EVENTOS_DESPESAS RESTART WITH 5;
CREATE SEQUENCE IF NOT EXISTS public.SEQ_EVENTOS_RECURSOS;
ALTER SEQUENCE SEQ_EVENTOS_RECURSOS RESTART WITH 5;

/*======================================================================================*/

DROP TRIGGER IF EXISTS tg_checagem_eventos ON eventos;

CREATE TRIGGER tg_checagem_eventos before INSERT, UPDATE ON eventos FOR EACH ROW EXECUTE PROCEDURE f_checagem_eventos();

CREATE OR REPLACE FUNCTION f_checagem_eventos() RETURNS trigger AS $$ DECLARE w_existe_evento integer; BEGIN
